    ...
    public static void main(String[] args) {
        ...
        switch(option){
            case 1:
                ...
                break;
            case 2:
                System.out.println("Enter your DNI to show your registered reservation:");
                int lookIdNumber = recogInt(in);

                boolean follow = false;
                for(Reserva p : reservations){
                    if(p.getIdNumber()==lookIdNumber){
                        p.showReserva();
                        follow=true;
                        break;
                    }
                ...
                if(!follow){
                    System.out.println("No reservation found with that DNI.");
                }
                break;
            case 3:
